      ...
      <div className={`border-b border-gold/10 overflow-hidden transition-all duration-300 group ${open ? 'bg-forest-dark/30' : 'hover:bg-forest-dark/20'}`}>
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <div className="pb-8 md:pl-[84px] text-slate-light leading-relaxed text-lg max-w-3xl">
                {answer}
              </div>
            </motion.div>
          )}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-forest text-offwhite relative pb-20 md:pb-0 font-sans">
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'glass-nav py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="text-2xl font-serif font-bold tracking-wide text-offwhite">
            Harmann Gill
          </a>
      ...
      <section className="relative min-h-[95vh] hero-bg flex items-center pt-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full pb-20 lg:pb-0">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[64px] font-serif text-offwhite leading-[1.1] mb-6">
              Build your Financial Blueprint with Clarity & Confidence
            </h1>
            
            <p className="text-offwhite/80 text-lg md:text-xl font-light leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
      ...
      <section className="py-24 bg-forest relative">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-serif text-offwhite mb-6">The Financial Planning Gap</h2>
            <p className="text-slate-light text-lg">Millions are working hard but falling behind. Without a plan, the default outcome is uncertainty.</p>
          </FadeIn>
      ...
      <section className="py-24 bg-forest relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <FadeIn className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-slate-light text-lg">We take the guesswork out of financial planning with a clear, step-by-step approach designed to give you total clarity and control.</p>
          </FadeIn>
      ...
      <section className="py-20 bg-forest-dark border-t border-gold/10 relative overflow-hidden">
         ...
         <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <FadeIn>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-offwhite mb-6">Ready to Take the First Step?</h2>
      ...
      <section className="py-24 bg-forest border-y border-gold/10">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
             <FadeIn>
                ...
                <p className="text-slate-light mb-10 leading-relaxed text-lg">We don't just offer advice; we provide a structured, long-term framework to ensure your family's financial stability and growth.</p>
      ...
      <section id="story" className="py-24 bg-forest border-y border-gold/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
           ...
           <FadeIn className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-slate-light leading-relaxed text-[16px] font-light">
                <p>
      ...
      <section id="workshops" className="py-24 bg-forest-dark text-offwhite relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
           <FadeIn className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-3xl md:text-5xl font-serif text-offwhite mb-6">Workshops & Seminars</h2>
              <p className="text-offwhite/70 text-lg">Empowering our community through foundational financial education and exclusive business partnership opportunities.</p>
           </FadeIn>
      ...
      <section className="py-24 bg-forest relative border-t border-gold/10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <FadeIn>
             ...
             <p className="text-slate-light mb-10 leading-relaxed text-lg">We partner with individuals and families who are serious about their financial future but lack the time or expertise to manage complex strategies alone.</p>
      ...
      <section id="contact" className="py-24 bg-forest border-t border-gold/10">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          <FadeIn>
            ...
            <p className="text-slate-light text-lg mb-12 leading-relaxed max-w-lg">Schedule a complimentary, no-obligation consultation to discover how we can align your finances with your life goals.</p>
            ...
            <div className="space-y-8 mb-12">
              <a href="tel:+12505036992" className="flex items-center gap-6 group">
                 ...
                 <div>
                   <p className="text-xs font-bold uppercase tracking-widest text-slate-light mb-1">Call Directly</p>
                   <p className="text-offwhite text-xl font-medium">+1 (250)-503-6992</p>
                 </div>
              </a>
              <a href="mailto:itsharmanngill@gmail.com" className="flex items-center gap-6 group">
                 ...
                 <div>
                   <p className="text-xs font-bold uppercase tracking-widest text-slate-light mb-1">Email Us</p>
                   <p className="text-offwhite text-xl font-medium">itsharmanngill@gmail.com</p>
                 </div>
              </a>
            </div>
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-forest-dark font-sans relative">
         ...
         <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
               <h4 className="text-white font-bold tracking-wider uppercase text-sm mb-6">Start Your Journey</h4>
         ...
         <div className="max-w-7xl mx-auto px-6 py-6 border-t border-gold/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-light text-center md:text-left">
           ...
           <div className="flex flex-wrap justify-center md:justify-end gap-6">
              ...
              <button onClick={() => setTermsOfServiceOpen(true)} className="hover:text-white transition-colors">Terms of Service</button>
           </div>
         </div>
      </footer>
      ...
      <a 
        ...
        target="_blank" 
        rel="noreferrer" 
        className="fixed bottom-24 md:bottom-8 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 hover:shadow-[0_8px_30px_rgba(37,211,102,0.6)] transition-all duration-300 md:bottom-8 flex items-center justify-center group"
      ...
      >
        ...
        <div className="absolute -left-36 top-1/2 -translate-y-1/2 bg-white text-forest text-sm font-bold px-4 py-2 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 shadow-lg whitespace-nowrap">
           Chat with us
        </div>
      </a>
